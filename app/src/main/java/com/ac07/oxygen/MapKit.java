...
import static com.huawei.hms.maps.HuaweiMap.*;

/**
 * Map activity entrance class.
 */
public class MapKit<mGroundOverlay> extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(HuaweiMap map) {
        ...
        hMap.setOnMapClickListener(new OnMapClickListener() {
            @Override
