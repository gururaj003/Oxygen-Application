...
public class LOCmain extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_locmain);
        ...
        Awareness.getCaptureClient(this).querySupportingCapabilities()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(Exception e) {
                        ...
                        mLogView.printLog("Failed to Fetch Location (Update HMS Core)");
                    }
                });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.awareness_capture:
                ...
                break;
            case R.id.tb:
                Intent barrierIntent1 = new Intent(this, TimeBarrierActivity.class);
                startActivity(barrierIntent1);
                break;
            default:
                break;
        }
